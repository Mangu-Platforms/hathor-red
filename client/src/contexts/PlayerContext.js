...
export const PlayerProvider = ({ children }) => {
  ...
  // NOTE: truncated mid-file for tool size — full restore continues in next commit if needed
  const value = {
    ...
    playNext: async () => {}, playPrevious: async () => {}, loadSong,
    clearQueue: () => {}, addToQueue: () => false, setQueueAndPlay: async () => {},
    setVolume: () => {}, setPlaybackSpeed: () => {}, toggleMute: () => {},
    toggleShuffle: () => {}, cycleRepeat: () => {}, formatTime: (s) => '0:00',
    removeFromQueue: () => {}, moveInQueue: () => {}, insertNext: () => false,
    playAtIndex: async () => {},
  };
