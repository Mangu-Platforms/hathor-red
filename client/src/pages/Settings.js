...
const Settings = () => {
  ...
  return (
    <div className="oly-page">
      ...
      {/* dose-5.9: honest privacy pillar — hide live export/delete when FEATURE_PRIVACY is off */}
      {features && features.privacy === false ? (
        <div className="oly-section">
          ...
          <div
            ...
            role="status"
          >
            Privacy pillar is off (FEATURE_PRIVACY). GDPR export, account-deletion requests, and
            privacy audit routes are not mounted on this server. Contact the operator if you need
            a data export outside the product API.
          </div>
        </div>
      ) : (
        <>
