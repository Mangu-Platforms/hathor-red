...
const Settings = () => {
  ...
  // dose-2.87 / dose-2.88: live client hints so mismatch / short / same-as-current
  // password is visible before submit
    ...
    <div className="oly-page">
      ...
      <div className="oly-section">
        ...
        <form onSubmit={savePassword} style={{ maxWidth: 420 }}>
              ...
              title={
                !passwordReady
                  ? pwSameAsCurrent
                    ...
                    : 'Fill current, new (8+ chars), and matching confirm'
                  : undefined
              }
            >
          ...
          {pwLiveHint && (
            <div
              className={`oly-msg ${pwMismatch || pwTooShort || pwSameAsCurrent ? 'err' : 'ok'}`}
              style={{ marginTop: 8 }}
              role="status"
              aria-live="polite"
            >
