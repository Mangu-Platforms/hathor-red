  ...
  return (
    <div className="oly-page">
      ...
      <div className="oly-section">
        ...
        <form onSubmit={saveProfile}>
          ...
          {avatarLiveHint && (
            <div
              className="oly-msg err"
              style={{ marginTop: 8, marginBottom: 0, maxWidth: 420 }}
              role="status"
              aria-live="polite"
            >
              {avatarLiveHint}
          ...
          <div className="oly-row" style={{ maxWidth: 420, marginTop: 12 }}>
            <button
              className="oly-btn"
              type="submit"
        ...
        {stats && (
          <div style={{ marginTop: 16 }}>
            ...
            <span className="oly-reason">{stats.playCount ?? stats.plays ?? 0} plays</span>
            {stats.totalListeningSeconds != null && (
              <span className="oly-reason">
                {Math.floor((stats.totalListeningSeconds || 0) / 60)} min listened
              </span>
            )}
          </div>
        )}
      ...
      <div className="oly-section">
        <h2>Password</h2>
        <p className="muted" style={{ marginBottom: 12 }}>
          Change your password. New password needs 8+ characters with upper, lower, and a digit.
        </p>
