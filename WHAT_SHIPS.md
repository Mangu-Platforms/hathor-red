...
Dose 2.88 closed (same-as-current password blocked + toast clear on edit). Remaining: further Dose 2 Settings polish if needed, or optional future shuffle-order drag. Do not start Dose 6+.
