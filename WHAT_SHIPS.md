...
Last updated: 2026-09-12 (dose-1.68 env port/interval toPositiveInt).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.68 (env port/interval toPositiveInt) |
| 2 Account | Soft logout + profile path present |
| 3–5 | Routes/flags/rooms as prior |

## Next item

Optional multi-device live queue list (not claimed); remaining raw parseInt on COLAB_* timeouts / MAX_FILE_SIZE / a few non-count paths.
