...
Last updated: 2026-09-13 (dose-1.73 ListeningRoom roomId positive-int).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.73 (client roomId int hygiene) |
| 2 Account | Soft logout + profile path present |
| 3–5 | Routes/flags/rooms as prior |

## Next item

Optional multi-device live queue list (not claimed); Dose 2 polish if playback regressions appear; remaining client parseInt on Rooms maxListeners / AIPlaylistGenerator songCount / MusicPlayer queue index are non-blocking.
