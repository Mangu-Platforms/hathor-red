...
- Redis invalidation on every socket `sync-state` (see BUGS.md)

## Next item

Dose 1 remaining: queue UI surface; Redis+socket playback sync consistency; confirm genres route if still missing.
