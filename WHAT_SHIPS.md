...
Dose 1.70 seek/formatTime edge guards closed. Next: small Dose 1/2 polish (e.g. keyboard seek, settings profile copy) or remove any remaining dead nav labels. No Dose 6+.
