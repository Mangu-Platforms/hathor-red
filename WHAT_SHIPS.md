...
Last updated: 2026-09-13 (dose-1.69 COLAB_* / MAX_FILE_SIZE toPositiveInt).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done through dose-1.69 (COLAB_* / MAX_FILE_SIZE toPositiveInt) |
| 2 Account | Soft logout + profile path present |
| 3–5 | Routes/flags/rooms as prior |

## Next item

Optional multi-device live queue list (not claimed); remaining raw parseInt on a few non-count paths (e.g. Range header bounds in songController, BPM/year buckets in discovery).
