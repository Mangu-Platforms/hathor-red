...
Last updated: 2026-09-11 (dose-1.25 authMiddleware normalize + stream-token reject).
...
|------|--------|
| 0 Truth | Done |
| 1 Playback | Core done; streamAuth hardened (dose-1.23); stream token username (dose-1.24); authMiddleware normalize (dose-1.25) |
