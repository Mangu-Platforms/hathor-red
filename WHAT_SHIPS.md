...
- Record listening on skip/mid-track change (ended-only for now)

## Next item

Dose 1.74 recordListening on ended closed. Next: Dose 2 settings profile copy polish, or record listening on skip/track-change threshold. No Dose 6+.
