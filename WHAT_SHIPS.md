...
Dose 2.94 closed (display-name empty live hint). Remaining: further Dose 2 Settings polish if needed, or optional future shuffle-order drag. Do not start Dose 6+.
