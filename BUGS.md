...
*   **Status**: **Closed in dose-1.16** — full PlayerContext (~27KB) restored on main with queue dedupe, insertNext move-to-play-next, and shuffle-aware makeNext/insertNext. Verify blob size after push.
